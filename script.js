document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorContainer(field) {
      ...
      if (!errorEl) {
        ...
        errorEl.style.cssText = 'display:block;color:#e53e3e;font-size:0.85em;margin-top:4px;';
    ...
    function validateField(field) {
      ...
      } else if (type === 'tel' && !validators.tel(value)) {
        errorMessage = messages.tel;
      } else if (minLength && value.trim() !== '' && !validators.minlength(value, minLength)) {
        errorMessage = typeof messages.minlength === 'function'
          ? messages.minlength(minLength)
          : messages.minlength;
      }

      const errorEl = getErrorContainer(field);
  ...
  if (animatableElements.length > 0) {
    ...
    defaultStyles.textContent = [
      '.fade-in, .animate-on-scroll, [data-animate] {',
      '  opacity: 0;',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הדרך למסה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7825700b-e55a-4270-9d66-0965c2e696d8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7825700b-e55a-4270-9d66-0965c2e696d8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7825700b-e55a-4270-9d66-0965c2e696d8';
